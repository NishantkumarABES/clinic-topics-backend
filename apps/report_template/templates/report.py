...
/* ---------- PATIENT INFO (TABLE INSTEAD OF GRID) ---------- */
...
<tr>
<th colspan="3">
{{patient_name}} — Patient ID: {{patient_id}}
</th>
</tr>

<tr>
<td><span class="label">Age:</span> {{patient_age}}</td>
<td><span class="label">Gender:</span> {{patient_gender}}</td>
<td><span class="label">Blood Group:</span> {{patient_blood_group}}</td>
</tr>

<tr>
<td><span class="label">Phone:</span> {{patient_phone}}</td>
<td colspan="2"><span class="label">Email:</span> {{patient_email}}</td>
</tr>
...
<div class="section-content">{{medical_opinion}}</div>
</div>

<div class="section">
<div class="section-title">Responses to Patient Questions</div>
<div class="section-content">{{patient_questions_responses}}</div>
</div>
...
<tr>
<td>
<img src="{{doctor_signature_url}}" style="max-height:50px;"><br>
...
This medical report contains confidential information intended solely
for the patient named above.
If received in error, contact {{clinic_phone}} immediately.
</div>
